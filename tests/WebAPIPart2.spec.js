...
//save the session storage into one context
test.beforeAll(async ({ browser }) => {
    ...
    await context.storageState({ path: 'state.json' });   //capture the whole session and save it as a json

    //invoke another browser context by using the above stored file
...
test('Client App Login', async ({ }) => {
    ...
    //skipped login and opened in new page
    await page.goto("https://rahulshettyacademy.com/client");
